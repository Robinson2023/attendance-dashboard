...
@section('content')
<h2 class="text-xl font-bold text-gray-800 mb-4">➕ Registrar Gasto de Alimentación</h2>
...
<div class="bg-white shadow rounded-lg p-6">
    <form action="{{ route('meals.store') }}" method="POST">
        ...
        <a href="{{ route('meals.index') }}" class="ml-2 text-gray-600 hover:underline">Cancelar</a>
